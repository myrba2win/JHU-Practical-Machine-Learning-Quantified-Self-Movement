...
Developer: <b>Myr Balada</b>  
GitHub Repo: [https://github.com/myrba2win/JHU-Practical-Machine-Learning-Quantified-Self-Movement](https://github.com/myrba2win/JHU-Practical-Machine-Learning-Quantified-Self-Movement)  
...
```{r warning=FALSE, error=FALSE}
#setwd("~/JHU/Practical Machine Learning/JHU-Practical-Machine-Learning-Quantified-Self-Movement")
```  
